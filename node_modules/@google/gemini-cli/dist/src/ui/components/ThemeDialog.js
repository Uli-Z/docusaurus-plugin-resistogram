...
export function ThemeDialog({ onSelect, onHighlight, settings, availableTerminalHeight, terminalWidth, }) {
    ...
    const [highlightedThemeName, setHighlightedThemeName] = useState(settings.merged.theme || DEFAULT_THEME.name);
    ...
    const otherScopeModifiedMessage = getScopeMessageForSetting('theme', selectedScope, settings);
