...
import { GitService, Logger, logSlashCommand, SlashCommandEvent, ToolConfirmationOutcome, } from '@google/gemini-cli-core';
 ...
 */
export const useSlashCommandProcessor = (config, settings, addItem, clearItems, loadHistory, refreshStatic, onDebugMessage, openThemeDialog, openAuthDialog, openEditorDialog, toggleCorgiMode, setQuittingMessages, openPrivacyNotice, openSettingsDialog, toggleVimEnabled, setIsProcessing, setGeminiMdFileCount) => {
            ...
            if (commandToExecute) {
                ...
                if (commandToExecute.action) {
                    if (config) {
                        ...
                        const event = new SlashCommandEvent(resolvedCommandPath[0], resolvedCommandPath.length > 1
