  ...
  return {
    ...
    async contentLoaded({ actions }) {
      ...
      for (const source of sources) {
        ...
        (0, import_fs_extra.writeJsonSync)(join(pluginDataDir, fileName), compressedData);
      ...
      const sharedData = {
        ...
        id2MainSyn: Object.fromEntries(
          new Map([...abx, ...org].map((r) => [r.amr_code, { name_de: r.full_name_de, name_en: r.full_name_en }]))
        ),
        id2ShortName: Object.fromEntries(
          new Map([...abx, ...org].map((r) => [r.amr_code, { name_de: r.short_name_de, name_en: r.short_name_en }]))
        ),
      ...
      (0, import_fs_extra.writeJsonSync)(join(pluginDataDir, sharedDataFileName), sharedData);
      const isDev = process.env.NODE_ENV === "development";
      if (isDev) {
        const staticDir = join(siteDir, "static", "resistogram-data", pluginId);
        (0, import_fs_extra.ensureDirSync)(staticDir);
        (0, import_fs_extra.copySync)(pluginDataDir, staticDir);
      }
